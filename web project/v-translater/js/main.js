...
socket.on('message', function(message) {
  console.log('Client received message:', message, message.type);
...
function handleRemoteStreamAdded(event) {
  ...
  remoteText.srcObject = "Hello dear";
}
...
// Modules for speech recoginition and speech Synthesis
